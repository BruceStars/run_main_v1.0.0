...
class Main {
    ...
    private gameInit() {
        ...
        Laya.loader.create(mainArr, Laya.Handler.create(this, function (p) {
            ...
            btn.label = "开始游戏";
            btn.on('click', this, function aaaa() {

                var k = 0;
                var man = this.scene.addChild(Laya.Sprite3D.instantiate(this.man, this.scene, false, new Laya.Vector3(0, 0, 0)));
            ...
            //设置灯光环境色
            this.scene.ambientColor = new Laya.Vector3(1.0, 1.0, 1.0);
    ...
    private buildingAction(lorR, number)  {
        if (lorR == 0)  {
            ...
            if (number == 0)  {
                ...
                var zhongBuilding1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.zhongBuilding, this.scene, false, new Laya.Vector3(-41, 28, leftBd - 0)));
                leftBd = leftBd - 39;
                build3DArr.push(zhongBuilding1);
            }
            else if (number == 1)  {
                var icbc1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.icbc, this.scene, false, new Laya.Vector3(-26, 2.2, leftBd + 15))) as Laya.Sprite3D;
                ...
                var guoqi1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.guoqi, this.scene, false, new Laya.Vector3(-31, 1, leftBd + 18))) as Laya.Sprite3D;
                leftBd = leftBd - 23;
                guoqi1.transform.rotate(new Laya.Vector3(0, 180, 0), true, false);
                build3DArr.push(guoqi1);
            }
            else if (number == 3)  {
                var zgh1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.zgh, this.scene, false, new Laya.Vector3(-30, 1, leftBd + 19))) as Laya.Sprite3D;
                zgh1.transform.rotate(new Laya.Vector3(0, 180, 0), true, false);
                leftBd = leftBd - 24;
                build3DArr.push(zgh1);
            } else if (number == 4)  {
                var chinaBank1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.chinaBank, this.scene, false, new Laya.Vector3(-29, 10, leftBd + 19))) as Laya.Sprite3D;
            ...
            if (number == 0)  {
                var zhongBuilding2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.zhongBuilding, this.scene, false, new Laya.Vector3(36, 28, rightBd - 0))) as Laya.Sprite3D;
                zhongBuilding2.transform.rotate(new Laya.Vector3(0, 180, 0), true, false);
                rightBd = rightBd - 40;
                build3DArr.push(zhongBuilding2);
            }
            else if (number == 1)  {
                var icbc1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.icbc, this.scene, false, new Laya.Vector3(19.8, 2.2, rightBd + 4))) as Laya.Sprite3D;
                rightBd = rightBd - 25;
                build3DArr.push(icbc1);

            }
            else if (number == 2)  {
                var guoqi1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.guoqi, this.scene, false, new Laya.Vector3(25, 1, rightBd))) as Laya.Sprite3D;
                rightBd = rightBd - 22;
                ...
                var zgh1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.zgh, this.scene, false, new Laya.Vector3(22, 1, rightBd))) as Laya.Sprite3D;

                rightBd = rightBd - 24;
                build3DArr.push(zgh1);
            } else if (number == 4)  {
                var chinaBank1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.chinaBank, this.scene, false, new Laya.Vector3(26, 10, rightBd))) as Laya.Sprite3D;
    ...
    private renwuLoad() {
        ...
        this.scene.addChild(this.renwu);
    ...
    private gouyaoweiLoad() {
        ...
        this.scene.addChild(this.gouyaowei);
    ...
    private xitieshiLoad() {
        ...
        this.scene.addChild(this.xitieshi);
    ...
    private lightLoad() {
        ...
        this.scene.addChild(this.lamp);
        var lamp1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.lamp, this.scene, false, new Laya.Vector3(11, 0, -30)));
    ...
    private treeLoad() {
        ...
        var tree1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(-40, -9, 30)));
        var tree2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(-40, -9, 25)));
        var tree3 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(-40, -9, 20)));
        var tree4 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(-40, -9, 15)));
    ...
    private chinaBankLoad() {
        ...
        this.scene.addChild(this.chinaBank);

        var chinaBank1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.chinaBank, this.scene, false, new Laya.Vector3(-29, 10, -90))) as Laya.Sprite3D;
        chinaBank1.transform.rotate(new Laya.Vector3(0, 180, 0), true, false);
        build3DArr.push(chinaBank1);
    ...
    private dimianLoad() {
        ...
        this.scene.addChild(road);
        roadArr.push(road);

        //克隆sprite3d
        var layaMonkey_clone1 = this.scene.addChild(Laya.Sprite3D.instantiate(road, this.scene, false, new Laya.Vector3(-3, 0, -136.5)));
        //克隆sprite3d
        roadArr.push(layaMonkey_clone1);
        var layaMonkey_clone2 = this.scene.addChild(Laya.Sprite3D.instantiate(road, null, false, new Laya.Vector3(-3, 0, -273)));
    ...
    private bigTaxiLoad() {
        ...
        this.scene.addChild(this.bigTaxi);
    ...
    private zhongLoad() {
        ...
        this.scene.addChild(this.zhongBuilding);

        var zhongBuilding1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.zhongBuilding, this.scene, false, new Laya.Vector3(36, 28, -35))) as Laya.Sprite3D;
    ...
    private guoqiLoad() {
        ...
        this.scene.addChild(this.guoqi);

        var guoqi1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.guoqi, this.scene, false, new Laya.Vector3(-25, 1, 8))) as Laya.Sprite3D;
        guoqi1.transform.rotate(new Laya.Vector3(0, 180, 0), true, false);
    ...
    private icbcLoad() {
        ...
        this.scene.addChild(this.icbc);

        var zhongBuilding1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.icbc, this.scene, false, new Laya.Vector3(-26, 2.2, -60))) as Laya.Sprite3D;
        zhongBuilding1.transform.rotate(new Laya.Vector3(0, 180, 0), true, false);
    ...
    private gameStart() {
        ...
        Laya.timer.frameLoop(1, this, function aaa() {
            ...
            if (Laya.LocalStorage.getItem("gameover") == "yes")  {
                ...
                gameIsOver = true;
                Laya.timer.pause();
                this.scene.removeChild(this.man);
                this.scene.removeChild(this.tiaodog);
                this.scene.removeChild(this.xiahuadog);
                Laya.timer.resume();
            ...
            if (Laya.LocalStorage.getItem("rocket") == "yes")  {
                ...
                Laya.timer.pause();
                this.scene.removeChild(this.man);
                this.scene.addChild(this.feidog);
                Laya.timer.resume();
                ...
                this.scene.addChild(this.rocketing);
            }
            ...
            if (rocketState)  {
                ...
                if (rocketTotal > 500)  {
                    Laya.timer.pause();
                    this.scene.addChild(this.man);
                    this.scene.removeChild(this.feidog);
                    Laya.timer.resume();

                    rocketTotal = 0;
                    rocketState = false;
                    this.scene.removeChild(this.rocketing)
                    r = 0;
            ...
            score = Math.floor((-a + 5) / 10) + parseInt(Laya.LocalStorage.getItem("score"));
    ...
    private rocketBuildAction() {
        ...
        let offsetX = -9 + i * 6;
        var coin1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2 + r, -(buildZ - 120))))
        var coin2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2 + r, -(buildZ - 110))))
        var coin3 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2 + r, -(buildZ - 100))))
        var coin4 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2 + r, -(buildZ - 90))))
        var coin5 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2 + r, -(buildZ - 80))))
    ...
    private rocketLoad() {
        ...
        this.scene.addChild(this.rocket);
        ...
        this.rocketing = Laya.Sprite3D.instantiate(this.rocket, this.scene, false, new Laya.Vector3(-3, 2, 200)) as Laya.MeshSprite3D;
    ...
    private coinLoad() {
        ...
        var coin1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(-3, 2, -30)));
        var coin2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(-3, 2, -40)));
        var coin3 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(-3, 2, -50)));
        var coin4 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(-3, 2, -60)));
    ...
    private buildLightAction() {
        this.tree.transform.position = new Laya.Vector3(11, 0, -40);
        var lamp1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.lamp, this.scene, false, new Laya.Vector3(11, 0, lightTotal - 30)));
        var lamp2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.lamp, this.scene, false, new Laya.Vector3(-18, 0, lightTotal - 30)));
        var tree1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(11, 0, lightTotal + 35)));
        var tree2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(-18, 0, lightTotal + 35)));
        var tree3 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(11, 0, lightTotal - 5)));
        var tree4 = this.scene.addChild(Laya.Sprite3D.instantiate(this.tree, this.scene, false, new Laya.Vector3(-18, 0, lightTotal - 5)));
        lightArr.push(lamp1);
        lightArr.push(lamp2);
        lightArr.push(tree1);
        lightArr.push(tree2);
            ...
            if (number == 0)  {
                ...
                if (rocketNum == 9)  {
                    if (rocket == 0)  {
                        rocket = 1;
                        let offsetX = -10 + i * 7;
                        arrr.push(this.scene.addChild(Laya.Sprite3D.instantiate(this.rocket, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 10)))));
                    }
                }
                if (rocketNum == 10)  {
                    if (rocket == 0)  {
                        rocket = 1;
                        let offsetX = -10 + i * 7;
                        arrr.push(this.scene.addChild(Laya.Sprite3D.instantiate(this.xitieshi, this.scene, false, new Laya.Vector3(offsetX, 3, -(buildZ + 10)))));
                    }
                }

            } else if (number == 1)  {
                let offsetX = -10 + i * 7;
                var coin1 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 10))));
                var coin2 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 20))));
                var coin3 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 30))));
                var coin4 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 40))));
                var coin5 = this.scene.addChild(Laya.Sprite3D.instantiate(this.coin, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 50))));
                arrr.push(coin1);
                arrr.push(coin2);
                arrr.push(coin3);
                arrr.push(coin4);
                ...
                arrr.push(this.scene.addChild(Laya.Sprite3D.instantiate(this.taxi, this.scene, false, new Laya.Vector3(offsetX, 2, -(buildZ + 20)))));
            }
            else if (number == 3)  {
                let offsetX = -9.8 + i * 7.1;
                // new Laya.Vector3(2,5,-100);
                arrr.push(this.scene.addChild(Laya.Sprite3D.instantiate(this.bigTaxi, this.scene, false, new Laya.Vector3(offsetX, 2.5, -(buildZ + 20)))));
            }
            else if (number == 4)  {
                let offsetX = -10 + i * 7.2;
                // new Laya.Vector3(2,5,-100);
                arrr.push(this.scene.addChild(Laya.Sprite3D.instantiate(this.zhangaiwu, this.scene, false, new Laya.Vector3(offsetX, 4, -(buildZ + 20)))));
            } else if (number == 5)  {
                let offsetX = -9.2 + i * 6.9;
                // new Laya.Vector3(2,5,-100);
                arrr.push(this.scene.addChild(Laya.Sprite3D.instantiate(this.bus, this.scene, false, new Laya.Vector3(offsetX, 4, -(buildZ + 20)))));
            }
            ...
            if (Laya.stage.mouseX < x && ((Math.abs(Laya.stage.mouseY - y) / (x - Laya.stage.mouseX)) < 1)) {
                ...
                if (y - Laya.stage.mouseY > 20)  {
                    if (!rocketState)  {
                        ...
                        this.scene.removeChild(this.man);
                        Laya.timer.resume();
                        this.scene.addChild(this.tiaodog);
                        tiaoState = 1;
                        Laya.timer.frameLoop(1, this, function aaa() {
                            if (!gameIsOver) {
                                kk = kk + 0.18;
                ...
                if (Laya.stage.mouseY - y > 20)  {
                    ...
                    if (!rocketState)  {
                        ...
                        this.scene.removeChild(this.man);
                        Laya.timer.resume();
                        this.scene.addChild(this.xiahuadog);
                        xiahuaState = 1;
                        Laya.timer.frameLoop(1, this, function aaa() {
                            if (!gameIsOver) {
                                kk = kk + 0.5;
